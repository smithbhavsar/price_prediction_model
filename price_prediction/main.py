    ...
    def run(self):
        with gr.Blocks(title="The Price is Right", fill_width=True) as ui:
            ...
            def run_with_logging(initial_log_data):
                ...
                self.get_agent_framework().planner.logger.addHandler(handler)
                self.get_agent_framework().planner.scanner.logger.addHandler(handler)
                self.get_agent_framework().planner.ensemble.logger.addHandler(handler)
                self.get_agent_framework().planner.messenger.logger.addHandler(handler)
