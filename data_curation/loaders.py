...
class ItemLoader:
    ...
    def from_datapoint(self, datapoint):
        ...
        try:
            ...
            print(f'EXCEPTION from_datapoint: {e}')
    ...
    def from_chunk(self, chunk):
        ...
        try:
            ...
            print(f'EXCEPTION from_chunk: {e}')
    ...
    def chunk_generator(self):
        ...
        try:
            ...
            print(f'EXCEPTION chunk_generator: {e}')
    ...
    def load_in_parallel(self, workers):
        ...
        try:
            ...
            print(f'EXCEPTION load_in_parallel ({type(e)}): {e}')
    ...
    def load(self, workers=8):
        """
        Load in dataset
        - workers specifies how many processes should work on loading and scrubbing the data
        - save specifies if the dataset should be saved to disk to avoid multiple downloads
        """
        start = datetime.now()

        print(f"Loading dataset {self.name} from Hugging Face", flush=True)
